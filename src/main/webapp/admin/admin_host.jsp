...
<body>
	...
	<section id="hostOnRoom" class="host-section">
    <h2>숙박 시설 목록</h2>
    <div class="host-container">
        
        <form action="<%= request.getContextPath() %>/uploadRoom.go" method="post" enctype="multipart/form-data">
    	숙소 이름: <input type="text" name="title" required><br>
    	...
    	예약 링크: <input type="text" name="link"><br>
    	이미지 업로드: <input type="file" name="roomImage" required><br>
    	<input type="submit" value="숙박 등록">
</form>
